...
project_router.register(r'url', views.MalwareUrlViewSet, base_name="url")
project_router.register(r'charts-dot', views.ChartDotAPIViewSet, base_name="chart-dot")
project_router.register(r'charts-dom', views.ChartDomAPIViewSet, base_name="chart-dom")
...
urlpatterns = [
    ...
    # Charts
    #url(r'^charts/', views.ChartAPIView.as_view(), name='chart-data'),
]
